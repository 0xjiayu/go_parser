...
class ModuleData():
    ...
    def parse(self, is_test=False):
        ...
        if not is_test:
            ...
            idc.set_cmt(self.start_addr + 4*ADDR_SZ, "funcs number",0)
            ...
            idc.set_cmt(self.start_addr + 7*ADDR_SZ, "source files number",0)
            ...
            idc.set_cmt(self.start_addr + 27*ADDR_SZ, "test section map addr",0)
            idc.set_cmt(self.start_addr + 28*ADDR_SZ, "test section map length",0)
            idc.set_cmt(self.start_addr + 29*ADDR_SZ, "test section map capacity",0)
            idc.set_cmt(self.start_addr + 30*ADDR_SZ, "typelink addr",0)
            idc.set_cmt(self.start_addr + 31*ADDR_SZ, "types number",0)
            idc.set_cmt(self.start_addr + 32*ADDR_SZ, "types table capacity",0)
            idc.set_cmt(self.start_addr + 33*ADDR_SZ, "itabslink addr",0)
            idc.set_cmt(self.start_addr + 34*ADDR_SZ, "itabs number",0)
            idc.set_cmt(self.start_addr + 35*ADDR_SZ, "itabs caapacity",0)
            idc.set_cmt(self.start_addr + 36*ADDR_SZ, "ptab addr",0)
            idc.set_cmt(self.start_addr + 37*ADDR_SZ, "ptab num",0)
